...
import (
	...
	fcmd "gl.king.im/king-lib/framework/service/cmd/job"
...
func initAppWrapper(lo log.Logger) (cron.Job, func(), error) {
	return initApp(bc.Server, bc.Data, bc.Biz, lo)
}

func initAppWrapperV2(bootData *service.ServiceBootData) (cron.Job, func(), error) {
...
func main() {
	...
	fcmd.Execute(&fcmd.ServiceInfo{
		...
		InitJobWrapper: initAppWrapperV2,
	})
}
